...
for ((h=1; h<=$2; h++))
do
        sbatch --output=/omega_ai/sim_out/mixtree_indistNB_indrate01_tips8_posprop05_500k.out \
                --error=/omega_ai/sim_out/mixtree_indistNB_indrate01_tips8_posprop05_500k.err \
                --time=48:00:00 \
                --cpus-per-task=2 \
                --ntasks=1 \
                --mem=512M \
...
# for ((h=1; h<=$2; h++))
# do
#         sbatch --output=/omega_ai/sim_out/sim_highsiteposprop_divbase_indistNB_indrate01_tips8_posprop05_500k.out \
#                 --error=/omega_ai/sim_out/sim_highsiteposprop_divbase_indistNB_indrate01_tips8_posprop05_500k.err \
#                 --time=48:00:00 \
#                 --cpus-per-task=2 \
#                 --ntasks=1 \
#                 --mem=512M \
...
# for ((h=1; h<=$2; h++))
# do
#         sbatch --output=/omega_ai/sim_out/sim_divbase_indistNB_indrate01_tips8_posprop05_100k.out \
#                 --error=/omega_ai/sim_out/sim_divbase_indistNB_indrate01_tips8_posprop05_100k.err \
#                 --time=120:00:00 \
#                 --cpus-per-task=2 \
#                 --ntasks=1 \
#                 --mem=512M \
...
#         sbatch --output=/omega_ai/sim_out/sim_5m_mixed_indistNB_indrate01_tips8_posprop05_validation.out \
#                 --error=/omega_ai/sim_out/sim_5m_mixed_indistNB_indrate01_tips8_posprop05_validation.err \
#                 --time=72:00:00 \
#                 --cpus-per-task=2 \
#                 --ntasks=1 \
#                 --mem=512M \
...
# bsub -o /omega_ai/sim_out/sim_%J.out -e /omega_ai/sim_out/sim_%J.err -M 256 -R "rusage[mem=256]" -n 2 python to_groups.py $start $end "0.4" "NB" "0.1" "true_div04_indistNB_indrate01_tips8_posprop05" "train" "clustal" 8 0.5 "true_align"
...
# for ((h=1; h<=$2; h++))
# do
#         sbatch --output=/omega_ai/sim_out/sim_%J.out --error=/omega_ai/sim_out/sim_%J.err --mem=256M --cpus-per-task=2 python to_groups.py $start $end "0.8" "NB" "0.1" "tester_div08_indistNB_indrate01_tips8_posprop05" "train" "clustal" 8 0.5
#         let start+=avg
#         let end+=avg
#         sleep 0.5
# done
...
# for ((h=1; h<=$2; h++))
# do
# 	bsub -q mpi -o /omega_ai/mpi_6_bsub_6_clustal/sim_%J.out -e /omega_ai/mpi_6_bsub_6_clustal/sim_%J.err -M 256 -R "rusage[mem=256]" -n 6 python to_groups.py $start $end "baseline" "NB" "0.1" "mpi_6_bsub_6_clustal" "train" "clustal" 8 0.5
# 	let start+=avg
# 	let end+=avg
# 	sleep 0.1
# done
...
# for ((h=1; h<=$2; h++))
# do
# 	bsub -q mpi -o /omega_ai/mafft_tests/mafft_test_single/sim_%J.out -e /omega_ai/mafft_tests/mafft_test_single/sim_%J.err -M 256 -R "rusage[mem=256]" -n 1 python to_groups.py $start $end "baseline" "NB" "0.1" "single_baseline_mafft" "train" "mafft" 8 0.5
# 	let start+=avg
# 	let end+=avg
# 	sleep 0.1
# done
...
# for ((h=1; h<=$2; h++))
# do
# 	bsub -q mpi -outdir /omega_ai/rafa_test_out/midsize_mpi_no_log_long/"%J"/ -o /omega_ai/rafa_test_out/midsize_mpi_no_log_long/"%J"/output -e /omega_ai/rafa_test_out/midsize_mpi_no_log_long/"%J"/error -M 256 -R "rusage[mem=256]" -n 1 python to_groups.py $start $end "baseline" "NB" "0.1" "test_mid_size_mpi_no_log_long" "train" "clustal" 8 0.5
# 	let start+=avg
# 	let end+=avg
# 	sleep 0.1
# done
...
# for ((h=1; h<=$2; h++))
# do
# 	bsub -q mpi -o /omega_ai/rafa_test_out/midsize_mpi/sim_%J.out -e /omega_ai/rafa_test_out/midsize_mpi/sim_%J.err -M 256 -R "rusage[mem=256]" -n 1 python to_groups.py $start $end "baseline" "NB" "0.1" "test_mid_size_mpi" "train" "clustal" 8 0.5
# 	let start+=avg
# 	let end+=avg
# 	sleep 0.1
# done
...
# for ((h=1; h<=$2; h++))
# do
#         bsub -q mpi -m hl-codon-30-01 -o /omega_ai/rafa_test_out/sim_%J.out -e /omega_ai/rafa_test_out/sim_%J.err -M 256 -R "rusage[mem=256]" -n 1 python to_groups.py $start $end "baseline" "NB" "0.1" "test_hl_codon_30_01" "train" "clustal" 8 0.5
#         let start+=avg
#         let end+=avg
#         sleep 0.1
# done
...
# for ((h=1; h<=$2; h++))
# do
#         bsub -q mpi -m hl-codon-33-01 -o /omega_ai/rafa_test_out/sim_%J.out -e /omega_ai/rafa_test_out/sim_%J.err -M 256 -R "rusage[mem=256]" -n 1 python to_groups.py $start $end "baseline" "NB" "0.1" "test_hl_codon_33_01" "train" "clustal" 8 0.5
#         let start+=avg
#         let end+=avg
#         sleep 0.1
# done
...
# for ((h=1; h<=$2; h++))
# do
#         bsub -q mpi -m hl-codon-32-01 -o /omega_ai/rafa_test_out/sim_%J.out -e /omega_ai/rafa_test_out/sim_%J.err -M 256 -R "rusage[mem=256]" -n 1 python to_groups.py $start $end "baseline" "NB" "0.1" "test_hl_codon_32_01" "train" "clustal" 8 0.5
#         let start+=avg
#         let end+=avg
#         sleep 0.1
# done
...
# for ((h=1; h<=$2; h++))
# do
#         bsub -q mpi -m hl-codon-31-01 -o /omega_ai/rafa_test_out/sim_%J.out -e /omega_ai/rafa_test_out/sim_%J.err -M 256 -R "rusage[mem=256]" -n 1 python to_groups.py $start $end "baseline" "NB" "0.1" "test_hl_codon_31_01" "train" "clustal" 8 0.5
#         let start+=avg
#         let end+=avg
#         sleep 0.1
# done
