...
for ((h=1; h<=$2; h++))
do
        sbatch --output=/hps/nobackup/goldman/charwest/omega_ai/sim_out/sim_divbase_indistNB_indrate01_tips8_posprop05_200codon_100k.out \
                --error=/hps/nobackup/goldman/charwest/omega_ai/sim_out/sim_divbase_indistNB_indrate01_tips8_posprop05_200codon_100k.err \
                --time=48:00:00 \
                --cpus-per-task=2 \
                --ntasks=1 \
                --mem=512M \
                --wrap "$conda_com && python to_groups.py $start $end 'baseline' 'NB' '0.1' 'divbase_indistNB_indrate01_tips8_posprop05_200codon_100k' 'train' 'clustal' 8 0.5"
...
#         sbatch --output=/hps/nobackup/goldman/charwest/omega_ai/sim_out/sim_5m_mixed_indistNB_indrate01_tips8_posprop05.out \
#                 --error=/hps/nobackup/goldman/charwest/omega_ai/sim_out/sim_5m_mixed_indistNB_indrate01_tips8_posprop05.err \
#                 --time=72:00:00 \
#                 --cpus-per-task=2 \
#                 --ntasks=1 \
#                 --mem=512M \
#                 --wrap "$conda_com && python to_groups.py $start $end '$div' 'NB' '0.1' '5m_mixed_indistNB_indrate01_tips8_posprop05' 'train' 'clustal' 8 0.5"
