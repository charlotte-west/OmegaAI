...
def create_NB_control(p0,p1,w0,w1,w2,tree,length,kappa,randomseed):
    start_cntrl = time.time()
    """
    Write an INDELible control file without indels.
    """
...
def simulate_align(ID, aligner, shuffle=False):
    ...
    print("indelible runtime: " + str(indelible_end))
    ...
    print("convert to AA seq runtime: " + str(aa_end) )
    ...
    if aligner == "clustal":
        ...
        print("Clustal runtime: " + str(clustal_end))
    ...
    print("Move files runtime: " + str(mv_files_end))
...
def main():
    ...
    print("Make dirs runtime: " + str(mkdir_end))
    ...
    print("Tree runtime: " + str(tree_end))
    ...
    for x in range(int(start),int(end)):
        ...
        print("Writing training data runtime: " + str(train_end))
        ...
        print("Writing params runtime: " + str(end_open))

        # write control file using either geometric or power law distributed indel lengths
        # if indel_distribution == "NB":
        create_NB_control(p0,p1,w0,w1,w2,tree_topology,length,k,randomseed=indelible_seed)
    ...
    print("Final OS operations runtime: " + str(os_end))
